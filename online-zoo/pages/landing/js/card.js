...
function createCard(animal) {
  ...
  cardImageName.classList.add('animal-name');
  ...
  title.classList.add('card-animal-title');

  title.textContent = animal.title;

  const descr = document.createElement('p');
  descr.classList.add('card-animal-descr');
  ...
  card.append(cardImage, title, descr, button);
